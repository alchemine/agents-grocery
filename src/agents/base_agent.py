...
class BaseAgent(metaclass=ABCMeta):
    def __init__(self, llm_provider: str, embeddings_provider: str) -> None:
        self._setup_inference_managers(llm_provider, embeddings_provider)
    ...
    def _setup_inference_managers(
        self, llm_provider: str, embeddings_provider: str
    ) -> None:
